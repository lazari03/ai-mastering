...
const DICT = {
  ...
  "app.tab.presets": { en: "My Presets", sq: "Presetet e Mia" },
  ...
  "console.savedArtists": { en: "My presets & artists", sq: "Presetet e mia & artistët" },
  "console.savedArtistsBody": {
    en: "Presets you built and artist chains you imported. Applied exactly as saved; private to your account.",
    sq: "Presetet që ke ndërtuar dhe zinxhirët e artistëve që ke importuar. Aplikohen saktësisht siç janë ruajtur; private për llogarinë tënde.",
  },
  "console.chooseArtist": { en: "Choose a preset…", sq: "Zgjidh një preset…" },
  "console.noSavedArtists": { en: "No saved presets yet", sq: "Ende pa presete të ruajtura" },
  ...
  "presetBar.unsaved": { en: "These settings aren't saved as a preset.", sq: "Këto cilësime nuk janë ruajtur si preset." },
  "presetBar.using": { en: "Using your preset “{name}”", sq: "Po përdor presetin tënd “{name}”" },
  ...
  "presetBar.save": { en: "Save as preset", sq: "Ruaj si preset" },
  "presetBar.saveAsNew": { en: "Save as new", sq: "Ruaj si të ri" },
  "presetBar.manage": { en: "My presets", sq: "Presetet e mia" },
  "presetBar.namePlaceholder": { en: "Preset name, e.g. Warm vocal EP", sq: "Emri i presetit, p.sh. Vokal i ngrohtë EP" },
  ...
  // ---- My Presets tab ----------------------------------------------------
  "myPresets.title": { en: "My Presets", sq: "Presetet e Mia" },
  "myPresets.subtitle": {
    en: "Your sound, saved: genre, style, objective and direction in one click. Build them here or save them from the mastering console.",
    sq: "Tingulli yt, i ruajtur: zhanri, stili, objektivi dhe drejtimi me një klik. Ndërtoji këtu ose ruaji nga konsola e masterimit.",
  },
  "myPresets.new": { en: "New preset", sq: "Preset i ri" },
  "myPresets.newTitle": { en: "New preset", sq: "Preset i ri" },
  "myPresets.editTitle": { en: "Edit preset", sq: "Ndrysho presetin" },
  ...
  "myPresets.create": { en: "Create preset", sq: "Krijo presetin" },
  ...
  "myPresets.emptyTitle": { en: "No presets yet", sq: "Ende pa presete" },
  "myPresets.emptyBody": {
    en: "Create one here, or dial in a sound in the mastering console and hit “Save as preset”.",
    sq: "Krijo një këtu, ose rregullo një tingull në konsolë dhe shtyp “Ruaj si preset”.",
  },
  "myPresets.howItWorks": {
    en: "A preset stores settings, not audio: each master still analyzes your track first and corrects what it measures, then applies your preset's direction. Imported artist chains (JSON) run their exact processing and are edited by re-importing.",
    sq: "Një preset ruan cilësime, jo audio: çdo master prapë analizon këngën tënde së pari dhe korrigjon atë që mat, pastaj aplikon drejtimin e presetit. Zinxhirët e importuar të artistëve (JSON) ekzekutojnë përpunimin e tyre të saktë dhe ndryshohen duke i ri-importuar.",
  },
